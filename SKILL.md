...
metadata: {"openclaw":{"requires":{"bins":["python3"]},"writablePaths":["deep-current/","deep-current-reports/"],"homepage":"https://github.com/madebydia/deep-current","author":"Diana (@madebydia)"}}
---
